...
-- Restore default Ctrl+v = Visual Block mode in Normal mode
map("n", "<C-v>", "<C-v>", { noremap = true, silent = true, desc = "Visual block" })

-- (Optional) Also restore in Select/Visual if desired
map({ "x", "s" }, "<C-v>", "<C-v>", { noremap = true, silent = true, desc = "Visual block" })
